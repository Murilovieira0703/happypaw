    ...
    <a href="index.php" class="btn btn-second back">Voltar</a>
        <div class="content first-content">
            ...
            <div class="second-column">
                ...
                <form action="cadastrado.php" id="myForm" method="POST" class="form" accept-charset='UTF-8'>
                    <label class="label-input" for="nomecadastro">
                        <i class="far fa-user icon-modify"></i>
                        <input name="nomecadastro" id="nomecadastro" type="text" value="" required placeholder="Nome"  maxlength="30" minlength="3">
                    </label>

                    <label class="label-input" for="sobrenomecadastro">
                        <i class="far fa-user icon-modify"></i>
                        <input name="sobrenomecadastro" id="sobrenomecadastro" type="text" value="" placeholder="Sobrenome" required  maxlength="60" minlength="3">
                    </label>
                    
                    <label class="label-input" for="emailcadastro">
                        <i class="far fa-envelope icon-modify"></i>
                        <input name="emailcadastro" id="emailcadastro" type="email" value="" required placeholder="E-mail" maxlength="100" minlength="12">
                    </label>
                    
                    <label class="label-input" for="senhacadastro">
                        <i class="fas fa-lock icon-modify"></i>
                        <input name="senhacadastro" id="senhacadastro" value="" required type="password" placeholder="A senha deve ter entre 8 e 16 caracteres..." maxlength="16" minlength="8">
                    </label>

                    <label class="label-input" for="password">
                        <i class="fas fa-lock icon-modify"></i>
                        <input type="password" name="passconfirmation" id="paseswordconfirmation" placeholder="Digite novamente sua senha" maxlength="16" minlength="8">
                    </label>
                    <div class="agreement">
        ...
        <div class="content second-content">
            ...
            <div class="second-column">
                ...
                <form class="form" action="" method="post">
                    ...
                    <label class="label-input" for="emailcadastro">
                        <i class="far fa-envelope icon-modify"></i>
                        <input name="emailcadastro" required type="email" placeholder="E-mail" maxlength="100" minlength="12">
                    </label>
                
                    <label class="label-input" for="emailcadastro">
                        <i class="fas fa-lock icon-modify"></i>
                        <input name="senhacadastro" required type="password" placeholder="Senha" maxlength="16" minlength="8">
                    </label>
